		...
		<div class="col col-4 course course-a" style='min-height: 400px;'>
			<div>
				...
				<p>
					...
					<span class="bonus-rate"><i>Guarantee Reward 30%(₱<?php echo number_format($row_packagex['cost_block'] * 0.30,2); ?>) up to 300% per cycle (up to 10 cycles every 90 days) or get ₱<?php echo number_format($row_packagex['cost_block_end'],2); ?> on payout directly.</i>
						<br/>
